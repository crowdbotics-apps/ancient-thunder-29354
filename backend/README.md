...
## Project Structure
    ...
    ├── ancient_thunder_29354  # Django project configurations
...
1. Clone this repo and `cd ancient_thunder_29354`
...
2. Clone this repo and `cd ancient_thunder_29354`
